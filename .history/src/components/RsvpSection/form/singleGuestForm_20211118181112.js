	...
	render() {
		...
		return (
			<form onSubmit={handleSubmit(this.onGuestFormSubmit)}>
				...
				{isChild && (
					<ChildrensMenuDesc>
						For any of our smaller guests they can decide on the day whether to have half portion of the main meal or a
					...
					<div>
						<Field
							...
							options={[
								...
								{
									label: 'Oven Baked Pave of Salmon, Pinot Grigio Leeks, Saffron & Prawn Veloute',
									value: 'Salmon',
								},
							]}
							component={RadioGroup}
              ...
              a vegetarian option'
				...
				<ButtonGroup right>
					...
					<Button buttonStyle={STYLES.PRIMARY} type='submit' disabled={invalid || submitting}>
						Next
					</Button>
				</ButtonGroup>
			</form>
