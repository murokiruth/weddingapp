...
const Rsvp = () => {
	...
	return (
		<>
									...
									<div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
										...
										<div className="mt-2">
											<p className="text-sm text-gray-500">
												...
												looks like we could not find you in our Guest list.
												please text or call <b>405-480-2243</b> to verify we
									...
									<div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
										...
										<div className="mt-2">
											<p className="text-sm text-gray-500">
												...
												your RSVP was successfully. Thank you for responding.
			...
			<section
				className="flex flex-col justify-center items-center px-8 py-16"
				id="rsvp"
			>
				<div className="mb-4 justify-center">
					<h1 className="text-4xl text-center pb-8">RSVP</h1>
