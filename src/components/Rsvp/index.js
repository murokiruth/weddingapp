...
const Rsvp = () => {
	...
	const handleRsvpSubmit = async (e) => {
		...
		const response = await API.post('weddingAPI', `/guests/${guest.firstlast}`, data);
	...
	return (
		<>
			...
			<section className='flex flex-col justify-center items-center px-8 py-16' id='rsvp'>
				...
				<form className='max-w-md w-full bg-white rounded space-y-4' onSubmit={handleSubmit} autoComplete='off'>
					<div>
						<input
