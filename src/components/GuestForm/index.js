...
const GuestForm = () => {
	...
	useEffect(() => {
		console.log('responded', guest.responded);
		...
		<>
			...
			<section className="flex flex-col justify-center items-center p-8">
				<div className="mb-4 justify-center">
					<h1 id="rsvp" className="text-4xl text-center">
						RSVP
					</h1>
					<p className="py-4">
						In order to allow all our guests an evening of relaxation, we have
						chosen for our wedding day to be an adult only occasion. We are
				...
				>
					...
					<div>
						<button className="w-full hover:bg-gray-300 rounded text-sm font-bold text-gray-50 transition duration-200 submit-button justify-center items-center">
							Submit
						</button>
					</div>
					<div></div>
								...
								<div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
									...
									<div className="relative flex-auto">
										...
										>
											...
											<div className="flex">
												<p className="inline-flex items-center mt-3 mr-5">
													Are You Attending?
												</p>
									...
									<div className="flex items-center justify-end p-4 rounded-b">
										<button
											className="w-32 h-12 bg-red-100 hover:bg-red-50 font-bold uppercase mr-14 px-8 py-4 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
											type="button"
											onClick={() => {
												setShowModal(false);
											}}
										...
										<button
											className="w-32 h-12 bg-gray-700 hover:bg-gray-300 px-8 py-4 mb-2 rounded text-sm font-bold text-gray-50 transition duration-200"
											type="submit"
											onClick={() => {
												handleRsvpSubmit();
												setShowModal(false);
